...
- **Use UV for Tool Execution**
  ...
  - Execute tools like pyright, ruff, and mailgun-mcp through UV: `uv run pyright`
...
- **Code Quality Validation**
  ...
  - Code should pass all quality checks when run through mailgun-mcp
  - The ultimate goal is to run `python -m mailgun-mcp -x -t` without any errors
...
- **Test Coverage Improvement (MANDATORY)**
  ...
  - **Target 42% milestone coverage**: Work toward 42% milestone (current: 46.1%, baseline: 19.6%).
...
- **MCP Server Integration**
  ...
  - MCP tools: `execute_mailgun-mcp`, `get_job_progress`, `get_comprehensive_status`
...
- **Quality Standards Maintenance**
  ...
  - Test all documentation updates by running `python -m mailgun-mcp --comprehensive`
